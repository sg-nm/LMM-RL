...
from openrlhf.datasets import MultiModalSFTDataset
from openrlhf.models import MultiModalActor
...
def train(args):
    ...
    with open(os.path.join("/home/suganuma/datasets/card_24/sft/train", "sft_data.json"), "r") as f:
        train_data = json.load(f)
    with open(os.path.join("/home/suganuma/datasets/card_24/sft/eval", "sft_data.json"), "r") as f:
