...
ray job submit --address="http://127.0.0.1:8265" \
   -- python3 -m openrlhf.cli.train_reinforce \
   --ref_num_nodes 1 \
   ...
   --save_steps -1 \
   --ckpt_path ./openrlhf/reinforce/checkpoint/qwen25-3-7B \
   --use_wandb 'suganuma' \
   --num_episodes 300 \
   --flash_attn \
   --l2 0.001 \
   ...
   --kl_estimator k3 \
   --log \
   --output_log_dir /home/suganuma/src/lmm-r1/openrlhf/reinforce/logs \
   --seed 42 \
   --gamma 1.0 \
   --no_verification \
